        ...
        <div class="section-cont">
            ...
            <div class="container stylization maincont">
                <div class="login">
                    <div class="auth-col">
                        <h2>Thêm mới</h2>
                        <form method="post" class="login" action="/model/create">
                            <p>
                                <label for="model">Model name</label><input type="text" name="name"
                                                                            id="model"
                                                                            required>
                            </p>
                            <p>
                                ...
                                <select id="categoryName" name="categoryID">
                                    <c:forEach var="item" items="${categories}">
                                        <option value="${item.id}"><c:out value='${item.categoryName}'/></option>
                                    </c:forEach>
                                </select>
                            </p>
                            <p class="auth-submit">
