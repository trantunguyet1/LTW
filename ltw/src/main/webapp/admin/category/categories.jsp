...
<main>
    <section class="container">
        ...
        <div class="section-cont">
            <p><a href="/categories/create">Create Category</a> <a style="padding-left: 100px" href="/model/create">Create
                Model</a></p>
            <br>
            <br>
            ...
            <table class="table table-hover table-text-center">
                ...
                <c:forEach var="item" items="${categories}" varStatus="loop">
                    <tr>
                        ...
                        <td><a href="/model/edit?id=<c:out value='${item.id}'/>">Edit</a><span>/ </span>
                            <a href="/model/delete?id=<c:out value='${item.id}'/>">Delete</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
