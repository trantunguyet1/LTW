        ...
        <div class="section-cont">
            ...
            <div class="container stylization maincont">
                <div class="login">
                    <div class="auth-col">
                        <h2>Cập nhật</h2>
                        <form method="post" class="login" action="/model/edit">
                            <p hidden>
                            ...
                            <p>
                                <label for="name">Model name </label><input type="text"
                                                                            name="name"
                                                                            id="name"
                                                                            required
                            ...
                            <p hidden>
                                <label for="categoryID">CategoryID</label><input type="text"
                                                                                 ...
                                                                                 id="categoryID"
                                                                                 required
                                                                                 value="<c:out value="${model.categoryID}"/>">
                            </p>
                            <p>
                                <label for="categoryName">Category name</label><input type="text"
                                                                                      ...
                                                                                      disabled
                                                                                      required
                                                                                      value="<c:out value="${model.categoryName}"/>">
                            </p>
                            <p class="auth-submit">
