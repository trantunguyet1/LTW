...
@WebServlet(name = "CartSubController", value = "/cart-sub")
public class CartSubController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Boolean add = cartDAO.subProductFromCart(user.getId(), product.getId(), user.getUserName(), product.getName(), product.getDiscount() != null ? product.getDiscount() : product.getPrice());
